...
```bash
git clone https://github.com/CrystalAlembic/FashionChameleon-180.git
cd FashionChameleon-180
python setup.py
```
...
### Prepare Environment
```
git clone https://github.com/CrystalAlembic/FashionChameleon-180
cd FashionChameleon
...
<!-- Last updated: 2026-06-06 15:42:07 -->
